...
const EditPg = () => {
      ...
      try {
        ...
        if (pg) {
          setFormData(prev => ({
            ...
            type: pg.pg_type || 'PG',
            genderType: pg.living_type || 'Boys',
            contact_person: pg.contact_person || '',
            mobile: pg.mobile || '',
            address_line_1: pg.address_line_1 || '',
            address_line_2: pg.address_line_2 || '',
            area: pg.area || '',
            ...
            propertyStatus: pg.property_status === false ? 'Inactive' : 'Active',
            amenities: pg.amenities || []
          }));
          
          if (pg.no_of_rooms) {
            setNumRooms(pg.no_of_rooms.toString());
          }
          if (pg.rooms && typeof pg.rooms === 'object' && !Array.isArray(pg.rooms)) {
            const roomsArray = Object.values(pg.rooms).map(r => ({
  ...
  const handleNumRoomsChange = (val) => {
    ...
    if (count > 0 && count <= 999) {
      setRooms(Array.from({ length: count }, (_, i) => ({
        roomNo: `10${i + 1}`,
        sharing: '2',
        rent: '8500',
        bhk: '2'
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      await api.put('/api/addpg/', payload);
      navigate('/pg-management');
    } catch (err) {
      console.error(err);
      setError(err.response?.data?.detail || err.response?.data?.error || err.message || "Failed to update PG property.");
    } finally {
  ...
  return (
    <div className="page-container">
      ...
      <div className="breadcrumb">
        ...
        <ChevronRight size={14} className="crumb-separator" />
        <span className="crumb-current">Edit PG Details</span>
      </div>
      ...
      <div className="alert-box alert-info-blue">
        <Info size={20} />
        <span>You are editing an active property. All changes will be saved after validation.</span>
      </div>
      ...
      <div className="form-section-card theme-blue">
        <div className="form-section-header">
          ...
          <div>
            ...
            <p className="form-section-subtitle">Update basic details about the property.</p>
          </div>
        </div>
        ...
        <div className="form-grid-4">
          ...
          <div className="form-group">
            <label className="form-label">Code / ID <span className="required">*</span></label>
            <input 
              type="text" 
            ...
            />
            <span className="form-helper-text">Auto-generated by system</span>
          </div>
          <div className="form-group">
          ...
          <div className="form-group">
            ...
            <input 
              ...
              onChange={(e) => handleTextChange('contact_person', e.target.value)}
            />
      ...
      <div className="form-section-card theme-green">
        <div className="form-section-header">
          ...
          <div>
            ...
            <p className="form-section-subtitle">Update the address details of the property.</p>
          </div>
        </div>
        ...
        <div className="form-grid-4">
          <div className="form-group">
            ...
            <input 
              ...
              onChange={(e) => handleTextChange('address_line_1', e.target.value)}
            />
          </div>
          <div className="form-group">
            ...
            <input 
              ...
              onChange={(e) => handleTextChange('address_line_2', e.target.value)}
            />
          </div>
          <div className="form-group">
      ...
      <div className="form-section-card theme-purple">
        <div className="form-section-header">
          ...
          <div>
            ...
            <p className="form-section-subtitle">Update the property capacity and pricing details.</p>
          </div>
        </div>
        ...
        <div className="alert-box alert-warning no-margin" style={{ marginTop: '24px' }}>
          <AlertTriangle size={16} />
          <span><strong>Important:</strong> Changing these settings may conflict with existing tenant allocations and billing. Please verify before updating.</span>
        </div>
      </div>
      ...
      <div className="form-section-card theme-orange">
        <div className="form-section-header">
          ...
          <div>
            ...
            <p className="form-section-subtitle">Update amenities available at this property.</p>
          </div>
        </div>
        ...
        <div className="alert-box alert-info-orange no-margin" style={{ marginTop: '24px' }}>
          <Info size={16} />
        ...
        {currentStep === 1 ? (
          ...
          <>
            ...
            <Button variant="primary" icon={<Save size={16} />} onClick={handleSubmit} disabled={isSubmitting}>
              {isSubmitting ? 'Updating...' : 'Update PG Details'}
            </Button>
          </>
        )}
      </div>
